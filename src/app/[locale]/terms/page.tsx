    ...
    <div className="py-16 sm:py-24">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 prose prose-gray">
        ...
        <div className="mt-12 space-y-8 text-gray-700">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#1A1A2E]">4. Disclaimer</h2>
            <p>
              Case studies and content are for educational purposes. Results may vary.
              We do not guarantee specific outcomes. Consult your legal and financial
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#1A1A2E]">6. Contact</h2>
            <p>For questions: hello@vailis.ai</p>
          </section>
        </div>
      </div>
    </div>
